...
class AssignmentTests: XCTestCase {
    ...
    func testDecode() {
        let data = """
            {"id":2363694,"object":"assignment","url":"https://www.wanikani.com/api/v2/assignments/2363694","data_updated_at":"2017-05-06T10:18:56.000000Z","data":{"created_at":"2015-02-07T00:11:03.000000Z","subject_id":3234,"subject_type":"vocabulary","level":10,"srs_stage":8,"srs_stage_name":"Enlightened","unlocked_at":"2016-02-07T00:11:03.000000Z","started_at":null,"passed_at":null,"burned_at":null,"available_at":"2017-09-03T09:00:00.000000Z","resurrected_at":null,"passed":true,"resurrected":false,"hidden":false}}
            """.data(using: .utf8)!
        ...
        do {
            ...
            let expected = ResourceCollectionItem(id: 2363694,
                                                  ...
                                                  data: Assignment(createdAt: makeUTCDate(year: 2015, month: 2, day: 7, hour: 0, minute: 11, second: 3),
                                                                   subjectID: 3234,
